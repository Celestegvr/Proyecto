...
CREATE USER VEND2 FOR LOGIN VEND2;
CREATE USER RESPVENTA FOR LOGIN RESPVENTA;
-- Grupo CAJA
CREATE USER CAJA1 FOR LOGIN CAJA1;
CREATE USER RESPCAJA FOR LOGIN RESPOCAJA;
-- Grupo BODEGA
CREATE USER BOD1 FOR LOGIN BOD1;
CREATE USER AUXBOD1 FOR LOGIN AUXBOD1;
CREATE USER RESPBOD FOR LOGIN RESPOBOD;
-- Grupo COMPRADOR
CREATE USER COMPRA1 FOR LOGIN COMPRA1;
-- Grupo CREDITO
CREATE USER RESPCRED FOR LOGIN RESPOCRED;
-- Grupo GERENCIA
